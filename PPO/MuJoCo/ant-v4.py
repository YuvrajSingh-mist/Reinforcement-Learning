...
def evaluate(envs, model, device, run_name, gamma, num_eval_eps=20, record=False, render_mode=None):
...
if __name__ == "__main__":
    ...
    if args.capture_video:
        ...
        episodic_returns, eval_frames = evaluate(envs, actor_network, device, run_name, args.gamma, record=True, num_eval_eps=30, render_mode='rgb_array')
