...
class Config:
    ...
    total_timesteps = 20_000_000  # Standard metric for vectorized training
    ...
    for i in tqdm(range(num_eval_eps), desc="Evaluating"):
        ...
        for agent in eval_env.agent_iter():
            ...
            with torch.no_grad():
                ...
                action, logprobs, _ = actor_networks[agent_idx].get_action(obs_tensor, deterministic=True)
...
if __name__ == "__main__":
    ...
    if args.capture_video:
        ...
        rewards_player1, rewards_player2, rewards_player3, avg_return1, avg_return2, avg_return3, eval_frames = evaluate(actor_networks, device, run_name, num_eval_eps=5, record=False)
